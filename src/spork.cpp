...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_11_NEW_PROTOCOL_ENFORCEMENT_4) r = SPORK_11_NEW_PROTOCOL_ENFORCEMENT_4_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_11_NEW_PROTOCOL_ENFORCEMENT_4") return SPORK_11_NEW_PROTOCOL_ENFORCEMENT_4;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_11_NEW_PROTOCOL_ENFORCEMENT_4) return "SPORK_11_NEW_PROTOCOL_ENFORCEMENT_4";
